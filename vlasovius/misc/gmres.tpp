            ...
            matmul_t matmul, gmres_config<real> &config )
{
    ...
    using std::memcpy;
    using std::memset;
    using vlasovius::blas  :: gemv;
    using vlasovius::lapack::larfg;
    using vlasovius::lapack::larfx;
    using vlasovius::lapack::trtrs;
    using vlasovius::gmres_impl::givens_rotation_from_rho;
    using vlasovius::gmres_impl::generate_givens_rotation;
